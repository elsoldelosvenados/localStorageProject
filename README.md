# Loacal storage project

This is a practical project in which the use of the local stoarge is evidenced, in this case it is used to store a list of reminders which are organized in order of importance.
